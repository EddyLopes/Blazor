...
public class TokenService : ITokenService
{
    ...
    private readonly IMultiTenantContextAccessor<ABCSchoolTenatInfo> _tenantContextAccessor;
    private readonly JwtSettings _jwtSettings;

    public TokenService(UserManager<ApplicationUser> userManager,
                       IMultiTenantContextAccessor<ABCSchoolTenatInfo> tenantContextAccessor,
    ...
    public async Task<TokenResponse> LoginAsync(TokenRequest request)
    {
        ...
        {
            throw new UnauthorizedException(["Tenant subscription is not active. Cantact administrator."]);
        }
        ...
        if (_tenantContextAccessor.MultiTenantContext.TenantInfo.Id is not TenancyConstants.Root.Id)
        {
            ...
            {
                throw new UnauthorizedException(["Tenant subscription has expired. Cantact administrator."]);
            }
        }
        #endregion
