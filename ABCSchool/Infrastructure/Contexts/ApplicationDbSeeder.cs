...
public class ApplicationDbSeeder
{
    ...
    public ApplicationDbSeeder(IMultiTenantContextAccessor<ABCSchoolTenatInfo> tenantInfoContextAccessor,
    ...
    private async Task AssingPermissionsToRoleAsync(IReadOnlyList<SchoolPermission> rolePermissions, ApplicationRole role, CancellationToken cancellationToken)
    {
    ...
    private async Task InitializeAdminUserAsync()
    {
        ...
        if(await _userManager.Users.SingleOrDefaultAsync(x => 
            x.Email == _tenantInfoContextAccessor.MultiTenantContext.TenantInfo.Email) is not ApplicationUser incomingUser)
        {
            ...
            incomingUser.PasswordHash = passwordHash.HashPassword(incomingUser, TenancyConstants.DefaultPassoword);
